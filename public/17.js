...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    return window.Laravel.isLoggedin ? this.$router.push('/admin-panel/announcements') : this.$router.push('/admin');
  },
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            {
              staticClass: "link",
              attrs: { to: "/admin-panel/announcements" }
            },
            [
              _c("img", {
                attrs: {
          ...
          _c(
            "router-link",
            { staticClass: "link", attrs: { to: "/admin-panel/our-team" } },
            [
              _c("img", {
                attrs: {
