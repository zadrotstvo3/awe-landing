...
var render = function() {
  ...
  return _c("div", { staticClass: "team-list" }, [
    _c(
      "ul",
      { staticClass: "list" },
      _vm._l(_vm.$t("teamList"), function(item, index) {
          ...
          item.avatar
            ? _c("div", { staticClass: "item" }, [
                _c("img", {
                  ...
                  attrs: {
                    src: __webpack_require__("./resources/js/assets/team_list sync recursive ^\\.\\/.*$")("./" + item.avatar),
                    alt: "avatar"
                  }
                }),
                _vm._v(" "),
