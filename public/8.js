...
var render = function() {
  ...
  return _c("div", { staticClass: "announcements-list" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "announcements-list__list" }, [
      _c(
        "ul",
        { staticClass: "list" },
        _vm._l(_vm.$t("announcementsList"), function(item, index) {
            ...
            _c("div", { staticClass: "list__announce" }, [
              _c("div", { staticClass: "announce" }, [
                _c("img", {
                  ...
                  attrs: {
                    src: __webpack_require__("./resources/js/assets sync recursive ^\\.\\/.*$")("./" + item.imgPath),
                    alt: "image"
                  }
                }),
                _vm._v(" "),
